--------------------------------------------------------
--  Arquivo criado - segunda-feira-agosto-22-2022   
--------------------------------------------------------
DROP TABLE "FUNCIONARIO" cascade constraints;
DROP TABLE "SORTE_VAGA_GARAGEM" cascade constraints;
DROP TABLE "VAGA_GARAGEM" cascade constraints;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE TABLE "VAGA_GARAGEM" 
   ...
   COMMENT ON COLUMN "VAGA_GARAGEM"."DISPONIVEL" IS 'Aceita apenas os caracteres 1 ou 0';
...
REM INSERTING into SORTE_VAGA_GARAGEM
SET DEFINE OFF;
REM INSERTING into VAGA_GARAGEM
SET DEFINE OFF;
...
--------------------------------------------------------
  ...
  USING INDEX "SORTE_VAGA_GARAGEM_PK"  ENABLE;
...
--------------------------------------------------------
  ...
  USING INDEX "VAGA_GARAGEM_PK"  ENABLE;
--------------------------------------------------------
